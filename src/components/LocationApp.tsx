        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            ...
            <div className="bg-brand-light/30 p-6 rounded-2xl border border-brand-light flex items-start space-x-4 shadow-xs">
              ...
              <div>
                ...
                <p className="text-xs text-brand-muted mt-1">
                  Atención en taller con cita previa para garantizar asesoramiento individualizado.
                </p>
              </div>
            </div>
            ...
            <div className="bg-brand-light/30 p-6 rounded-2xl border border-brand-light flex items-start space-x-4 shadow-xs">
              ...
              <div>
                ...
                <p className="text-sm text-brand-dark/80 mt-1">
                  <span className="font-semibold">Lunes a Viernes:</span> 08:00 a 18:00 hs
                </p>
                <p className="text-sm text-brand-dark/80">
                  <span className="font-semibold">Sábados:</span> 09:00 a 13:00 hs
                </p>
              </div>
            </div>
            ...
            <div className="bg-brand-light/30 p-6 rounded-2xl border border-brand-light flex items-start space-x-4 shadow-xs">
              ...
              <div>
                ...
                <p className="text-sm text-brand-dark/80 mt-1">
                  Córdoba Capital, Gran Córdoba, Villa Carlos Paz y zonas aledañas.
                </p>
                <p className="text-xs text-brand-muted mt-1">
                  Flete propio y equipo de montaje en domicilio disponible.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 min-h-[350px] sm:min-h-[420px] rounded-2xl overflow-hidden shadow-md border border-brand-light relative bg-gray-100">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d108985.34237190013!2d-64.2589578!3d-31.4166299!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9432985f478f5b69%3A0xb0a24f9a5366b092!2sC%C3%B3rdoba%2C%20Argentina!5e0!3m2!1ses!2sar!4v1700000000000!5m2!1ses!2sar"
              width="100%"
              height="100%"
